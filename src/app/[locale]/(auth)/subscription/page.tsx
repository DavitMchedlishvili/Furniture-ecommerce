  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-slate-700 dark:text-white">
      <div className="w-[70%] mt-[90px] p-6 bg-white border border-gray-300 rounded-lg shadow-md dark:bg-slate-700 dark:border-slate-800 max-h-[800px] overflow-y-auto scrollbar">
        <h2 className="text-2xl font-bold text-center dark:text-black text-gray-700 mb-6">Discover Exclusive Furniture Trends</h2>
        <p className="w-full text-center my-5 italic">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="border p-4 ">
          <h2 className="text-xl font-bold ">Monthly Digital Catalogue</h2>
          <p className="text-lg font-semibold mt-2 text-green-600">$4.99/month</p>
          <ul className=" min-h-[150px] mt-5">
        ...
        <div className="border p-4">
          <h2 className="text-xl font-bold">Quarterly Print Catalogue</h2>
        ...
        <div className="border p-4">
          <div>
          <h2 className="text-xl font-bold">Premium VIP Catalogue</h2>
